...
ACC_IMAGES = {
    "capa-melhores-hubs-usbc-2026.png": {
        "url": "https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=1200&h=630&fit=crop&q=85", # Laptop / Tech Accessories
        "accent": (147, 51, 234)
    }
}

for filename, spec in ACC_IMAGES.items():
