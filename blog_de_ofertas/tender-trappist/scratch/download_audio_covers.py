...
AUDIO_IMAGES = {
    "capa-melhores-fones-tws-2026.png": {
        "url": "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=1200&h=630&fit=crop&q=85", # Wireless TWS Earbuds
        "accent": (0, 229, 255)
    },
    "capa-anc-vs-pnc-2026.png": {
        "url": "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1200&h=630&fit=crop&q=85", # Over-ear headphones
        "accent": (99, 102, 241)
    },
    "capa-melhores-caixas-de-som-2026.png": {
        "url": "https://images.unsplash.com/photo-1545454675-3531b543be5d?w=1200&h=630&fit=crop&q=85", # Bluetooth Speaker
        "accent": (236, 72, 153)
    }
}

for filename, spec in AUDIO_IMAGES.items():
