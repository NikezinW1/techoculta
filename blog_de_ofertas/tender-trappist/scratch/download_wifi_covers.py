...
WIFI_IMAGES = {
    "capa-melhores-roteadores-wifi6-2026.png": {
        "url": "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=1200&h=630&fit=crop&q=85", # Wi-Fi Router / Server tech
        "accent": (0, 229, 255)
    },
    "capa-wifi5-vs-wifi6-vs-wifi7-2026.png": {
        "url": "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1200&h=630&fit=crop&q=85", # Network infrastructure
        "accent": (16, 185, 129)
    },
    "capa-melhores-repetidores-wifi-2026.png": {
        "url": "https://images.unsplash.com/photo-1563770660941-20978e870e26?w=1200&h=630&fit=crop&q=85", # Smart home plug / repeater
        "accent": (245, 158, 11)
    }
}

for filename, spec in WIFI_IMAGES.items():
