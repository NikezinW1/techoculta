...
# Exact file titles of actual Air Fryer machines in Wikimedia Commons
titles = [
    "File:Clickon Air Fryer.jpg", 
    "File:Ninja Foodi MAX Health Grill & Air Fryer AG551EU.jpg",
    "File:CombiMicroWaveOven.jpg"
]
    ...
    try:
        ...
        for page_id, page_info in pages.items():
            ...
            if imageinfo:
                ...
                print("Trying Air Fryer Machine URL:", file_url)
                
                temp_path = os.path.join(OUTPUT_DIR, "temp_airfryer_appliance.jpg")
                ...
                print("SUCCESS: Saved exact Air Fryer machine photo to", target_file)
